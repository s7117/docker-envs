...
# Base
docker buildx build ./base/20.04/Dockerfile --no-cache \
                        --platform linux/amd64,linux/arm64 \
                        --tag s7117/ubuntu-cuda:20.04
docker buildx build ./base/22.04/Dockerfile --no-cache \
                        --platform linux/amd64,linux/arm64 \
                        --tag s7117/ubuntu-cuda:22.04
docker buildx build ./base/latest/Dockerfile --no-cache \
                        --platform linux/amd64,linux/arm64 \
...
# Miniforge3
docker buildx build ./conda/Dockerfile --no-cache \
                        --platform linux/amd64,linux/arm64 \
...
# Coral TPU
docker buildx build ./coraltpu/Dockerfile --no-cache \
                        --platform linux/amd64,linux/arm64 \
...
docker buildx build ./cuda/11.8/Dockerfile --no-cache \
                        --platform=linux/amd64 \
                        --tag s7117/ubuntu-cuda:11.8
docker buildx build ./cuda/12.2/Dockerfile --no-cache \
                        --platform=linux/amd64 \
                        --tag s7117/ubuntu-cuda:12.2
docker buildx build ./cuda/12.4/Dockerfile --no-cache \
                        --platform=linux/amd64 \
                        --tag s7117/ubuntu-cuda:12.4
docker buildx build ./cuda/12.6/Dockerfile --no-cache \
                        --platform=linux/amd64 \
...
docker buildx build ./cuda-conda/11.8/Dockerfile --no-cache \
                        --platform=linux/amd64 \
                        --tag s7117/ubuntu-cuda-conda:11.8
docker buildx build ./cuda-conda/12.2/Dockerfile --no-cache \
                        --platform=linux/amd64 \
                        --tag s7117/ubuntu-cuda-conda:12.2
docker buildx build ./cuda-conda/12.4/Dockerfile --no-cache \
                        --platform=linux/amd64 \
                        --tag s7117/ubuntu-cuda-conda:12.4
docker buildx build ./cuda-conda/12.6/Dockerfile --no-cache \
                        --platform=linux/amd64 \
